...
class PropagationModelGUI:
    def __init__(self, root):
        ...
        # Dropdown list for selecting propagation model
    ...
    def plot_graph(self, dist, loss, model):
        ...
        canvas.draw()
        canvas.get_tk_widget().pack(side="top", fill="both", expand='True')  # Place the plot on the right side
        #canvas.pack_propagate(False)

        # Optionally, add a toolbar for navigation
